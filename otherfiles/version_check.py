...
README_ITEMS = [
    ...
    "pip install ipforce=={0}"]

SETUP_ITEMS = [
    "version='{0}'",
    "https://github.com/openscilab/ipforce/tarball/v{0}"]

CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/openscilab/ipforce/compare/v{0}...dev",
    "[{0}]:"]

PARAMS_ITEMS = ['IPFORCE_VERSION = "{0}"']
ISSUE_TEMPLATE_ITEMS = ["- IPForce {0}"]
